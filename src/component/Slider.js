  ...
  return (
    <div id="works" className="m-auto relative ">
      <div className="slider-container">
        <div className="flex left-1 sm:left-9 relative  m-auto w-[56%] lg:w-[53%] 2xl:max-w-[13%]    justify-start top-52">
        ...
        <Slider {...settings}>
          {data.map((ele) => (
            <div
              className="  flex top-[300px] m-auto  mt-[250px] lg:w-[82%]  2xl:max-w-[87%]  flex-col"
              key={ele.title}
            >
              <div className="mb-8 m-auto max-w-full">
                ...
                <img
                  className="lg:w-[33%] m-auto w-[80%] sm:w-[48%]"
                  src={ele.img}
                  alt="github"
                />
                <div className="flex flex-col sm:text-xl sm:gap-5  w-[80%] sm:w-[62%] 2xl:w-[34%]   relative top-5 items-start m-auto">
              ...
              <div
                className=" flex  max-w-[83%]   sm:w-[52%]
    justify-start w-full gap-10 sm:items-start   sm:mb-7 sm:mt-14 sm:text-xl text-sm lg:gap-20 xl:w-[42%]  m-auto relative xl:right-16 z-10 lg:w-[60%] 2xl:w-[23rem]"
              >
                <a
