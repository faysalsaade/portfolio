...
const Achievements = () => {
  return (
          ...
          <div className="mx-auto flex flex-col lg:items-center my-8">
            ...
            <div className="flex flex-col sm:text-xl sm:gap-5  w-5/6 sm:w-2/3 relative top-5 items-start ">
              <ul className="flex items-start justify-around w-6 my-4">
                {ele.tags.map((lang) => (
                  <li
                    className=" rounded  p-1 text-[9.6px] sm:text-xs sm:px-3 sm:py-1 mx-1 bg-[#E6DFD3] text-[#716D69] "
                    key={lang}
                  >
                    {lang}
                  </li>
    ...
    justify-start w-11/12 gap-10 sm:items-start   sm:my-7 sm:text-xl text-sm lg:gap-10 xl:w-96  m-auto relative xl:right-16 z-10"
          >
            <a
